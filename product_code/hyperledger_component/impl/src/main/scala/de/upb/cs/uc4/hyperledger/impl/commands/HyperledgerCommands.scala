...
final case class SubmitProposal(unsignedProposal: Array[Byte], signature: Array[Byte], replyTo: ActorRef[StatusReply[Array[Byte]]]) extends HyperledgerReadCommand[Array[Byte]]
