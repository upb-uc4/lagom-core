...
trait DefaultTestUsers {
  ...
  val student0: Student = Student("student0", Role.Student, address0, "firstName", "LastName", "example0@mail.de", "+49123456789", "1990-12-11", "", "7426915")
  val student1: Student = Student("student1", Role.Student, address1, "Aname", "Bname", "exampleD@mail.de", "+49123486688", "1995-04-11", "", "7363186")
  val student2: Student = Student("student2", Role.Student, address2, "Volder", "Hahmer", "example2@mail.de", "+49156879773", "2001-02-27", "", "4185966")
  ...
  val lecturer0: Lecturer = Lecturer("lecturer0", Role.Lecturer, address0, "firstName", "LastName", "example@mail.de", "+49123456789", "1991-12-11", "Heute kommt der kleine Gauss dran.", "Mathematics")
  val lecturer1: Lecturer = Lecturer("lecturer1", Role.Lecturer, address1, "Aname", "Bname", "exampleD@mail.de", "+49123486688", "1995-02-13", "Heute kommt nicht der kleine Gauss dran.", "Philosophy")
  val lecturer2: Lecturer = Lecturer("lecturer2", Role.Lecturer, address2, "Volder", "Hahmer", "example2@mail.de", "+49156879773", "2001-10-01", "Heute kommt der große Gauss dran.", "Physics")
  ...
  val admin0: Admin = Admin("admin0", Role.Admin, address0, "firstName", "LastName", "example@mail.de", "+49123456789", "1992-12-11")
  val admin1: Admin = Admin("admin1", Role.Admin, address1, "Aname", "Bname", "exampleD@mail.de", "+49123486688", "1995-02-13")
  val admin2: Admin = Admin("admin2", Role.Admin, address2, "Volder", "Hahmer", "example2@mail.de", "+49156879773", "2001-10-01")
