...
trait DefaultTestUsers {
  ...
  val lecturer0: Lecturer = Lecturer("lecturer0", Role.Lecturer, address0, "firstName", "LastName", "Picture", "example@mail.de", "+49123456789", "1991-12-11", "Heute kommt der kleine Gauss dran.", "Mathematics")
  val lecturer1: Lecturer = Lecturer("lecturer1", Role.Lecturer, address1, "Aname", "Bname", "cPicture", "exampleD@mail.de", "+49123486688", "1995-02-13", "Heute kommt nicht der kleine Gauss dran.", "Philosophy")
  val lecturer2: Lecturer = Lecturer("lecturer2", Role.Lecturer, address2, "Volder", "Hahmer", "Picture", "example2@mail.de", "+49156879773", "2001-10-01", "Heute kommt der große Gauss dran.", "Physics")
  ...
  val admin1: Admin = Admin("admin1", Role.Admin, address1, "Aname", "Bname", "cPicture", "exampleD@mail.de", "+49123486688", "1995-02-13")
  val admin2: Admin = Admin("admin2", Role.Admin, address2, "Volder", "Hahmer", "Picture", "example2@mail.de", "+49156879773", "2001-10-01")
