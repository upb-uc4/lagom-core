...
class UserSpec extends AnyWordSpecLike with Matchers {
  ...
  val student0: Student = Student("student0", Role.Student, address0, "VollDer", "Hammer", "Picture", "example@mail.de", "+49123456789", "1990-12-11", "SS2020", "7421769")
  val student1: Student = Student("student0", Role.Lecturer, address0, "", "", "Picture", "org.exampleatmail", "49 123456789","11-12-1996a", "WS1993/81", "--a,s@")
