...
class UserSpec extends AnyWordSpecLike with Matchers {
  ...
  val student0: Student = Student("student0", Role.Student, address0, "VollDer", "Hammer", "Picture", "example@mail.de", "1990-12-11", "SS2020", "7421769")
  val student1: Student = Student("student0", Role.Lecturer, address0, "", "", "Picture", "org.exampleatmail", "11-12-1996a", "WS1993/81", "--a,s@")
  ...
  val lecturer1: Lecturer = Lecturer("lecturer0", Role.Student, address0, "", "", "P1ctur3", "130SS@@mail.de", "19912-121-111", "╬þv¦e1┐‗☺❤🍕🍕😘😒", "🏆Pokemon Trainer💦")
  val admin0: Admin = Admin("admin0", Role.Admin, address0, "firstName", "LastName", "Picture", "example@mail.de", "1992-12-11")
  val admin1: Admin = Admin("admin0", Role.Student, address0, "", "", "🔫🔫🔫🔫", "example.mail@de", "Gestern, den 12.11.1995")
  ...
  "A Student" should {
      ...
      "return validation errors" in {
        ...
        val errorVariables = errors.map(error => error.name)
        errorVariables should contain only ("role","email","birthDate", "firstName", "lastName","matriculationId")
      }
  }
