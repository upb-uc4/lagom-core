...
import de.upb.cs.uc4.shared.client.exceptions.{ UC4Exception, SimpleError, ErrorType }
import de.upb.cs.uc4.shared.client.exceptions
import de.upb.cs.uc4.shared.client.exceptions.{ CustomException, ErrorType, SimpleError }
      ...
      override def deserialize(wire: ByteString): Message = {
        ...
        jsValue.validate[Message] match {
          ...
          case JsError(errors) =>
            ...
            throw new UC4Exception(400, exceptions.DetailedError(ErrorType.JsonValidation, errorList))
        }
      }
    }
